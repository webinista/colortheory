...
export const OPTIONS_COLOR_SCHEME = [
  { label: 'Complementary', value: '2' },
  { label: 'Analagous', value: '3' },
  { label: 'Triad', value: '3' },
  { label: 'Split Complementary', value: '3' },
...
export const OPTIONS_COLOR_INPUT_MESSAGE = 'Use any valid CSS color value, except those with an alpha component.';
